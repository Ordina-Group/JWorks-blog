...
It can use OpenTelemetry traces and Prometheus metrics
...
Using this metadata Keptn can observe your deployments for your application and identify bad deployments.

You can check acceptable response times by specifying SLI,
SLO and SLA's.
This makes it easier to track your applications real health and improves your day two operations. 
