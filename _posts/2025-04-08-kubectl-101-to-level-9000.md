...
image: /img/2025-04-08-kubectl-101-to-level-9000/logo.png
...
There are 2 plugins in kubectl which make switching between clusters and namespaces easier. Both can be easily installed through kubectl krew (another superpower we'll discuss later): [kubectx and kubens](https://github.com/ahmetb/kubectx){:target="_blank" rel="noopener noreferrer"}. 
